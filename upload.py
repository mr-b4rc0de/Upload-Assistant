...
from src.trackers.VHD import VHD
import json
...
async def do_the_thing(base_dir):
    ...
    for path in queue:
            ...
            with open(f"{base_dir}/tmp/{os.path.basename(path)}/meta.json") as f:
                ...
                for key, value in saved_meta.items():
                    overwrite_list = [
                        ...
                        'hdb', 'ptp', 'blu', 'no_season', 'no_aka', 'no_year', 'no_dub', 'no_tag', 'no_edition', 'no_seed', 'client', 'desclink', 'descfile', 'desc', 'draft', 'region', 'freeleech', 
        ...
        api_trackers = ['BLU', 'AITHER', 'STC', 'R4E', 'STT', 'RF', 'ACM','LCD','LST','HUNO', 'SN', 'LT', 'NBL', 'ANT', 'JPTV', 'TDC', 'OE', 'BHDTV', 'RTF', 'ULCX', 'FNP', 'VHD']
        ...
        tracker_class_map = {
            ...
            'TL' : TL, 'TDC' : TDC, 'HDT' : HDT, 'MTV': MTV, 'OE': OE, 'BHDTV': BHDTV, 'RTF': RTF, 'ULCX' : ULCX, 'FNP': FNP, 'VHD': VHD}
